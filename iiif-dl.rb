...
def download_identifier(identifier, final_filename = nil, attempt_full = true, v2 = false, width = nil, height = nil)
  ...
  iiif_manifest['sequences'].each do |sequence|
    ...
    sequence['canvases'].each do |canvas|
      ...
      canvas['images'].each do |image|
        ...
        download_identifier(identifier, final_filename, true, v2, width, height)
        current_image += 1
      end # image loop
      current_canvas += 1
    end # canvas loop
